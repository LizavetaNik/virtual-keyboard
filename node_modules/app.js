import { createLine } from 'createKeyboard';
let lang = 'en';
...
function createArrButton(){
  ...
  arrButton.push(createButton('Q', String.fromCharCode(0x0439), 'button_style'));
  arrButton.push(createButton('W', String.fromCharCode(0x0446), 'button_style'));
  arrButton.push(createButton('E', String.fromCharCode(0x0423), 'button_style'));
  arrButton.push(createButton('R', String.fromCharCode(0x041A), 'button_style'));
  arrButton.push(createButton('T', String.fromCharCode(0x0414), 'button_style'));
  arrButton.push(createButton('Y', String.fromCharCode(0x041D), 'button_style'));
  arrButton.push(createButton('U', String.fromCharCode(0x0413), 'button_style'));
  arrButton.push(createButton('I', String.fromCharCode(0x0428), 'button_style'));
  arrButton.push(createButton('O', String.fromCharCode(0x0429), 'button_style'));
  arrButton.push(createButton('P', String.fromCharCode(0x0417), 'button_style'));
  arrButton.push(createButton('[', String.fromCharCode(0x0425), 'button_style'));
  arrButton.push(createButton(']', String.fromCharCode(0x042A), 'button_style'));
  arrButton.push(createButton('\\', ' / ', 'button_style'));
  arrButton.push(createButton('DEL', 'DEL', 'button_style_func'));

  //line3 - [29, 41]
  arrButton.push(createButton('Caps Lock', 'Caps Lock', 'button_style_func'));
  arrButton.push(createButton('A', String.fromCharCode(0x0424), 'button_style'));
  arrButton.push(createButton('S', String.fromCharCode(0x042B), 'button_style'));
  arrButton.push(createButton('D', String.fromCharCode(0x0432), 'button_style'));
  arrButton.push(createButton('F', String.fromCharCode(0x0430), 'button_style'));
  arrButton.push(createButton('G', String.fromCharCode(0x043F), 'button_style'));
  arrButton.push(createButton('H', String.fromCharCode(0x0440), 'button_style'));
  arrButton.push(createButton('J', String.fromCharCode(0x043E), 'button_style'));
  arrButton.push(createButton('K', String.fromCharCode(0x043B), 'button_style'));
  arrButton.push(createButton('L', String.fromCharCode(0x0434), 'button_style'));
  arrButton.push(createButton(';', String.fromCharCode(0x0436), 'button_style'));
  arrButton.push(createButton(String.fromCharCode(0x0027), String.fromCharCode(0x044D), 'button_style'));
  arrButton.push(createButton('Enter', 'Enter', 'button_style_func'));

  //line4 - [42, 54]
  arrButton.push(createButton('Shift', 'Shift', 'button_style_func'));
  arrButton.push(createButton('Z', String.fromCharCode(0x044F), 'button_style'));
  arrButton.push(createButton('X', String.fromCharCode(0x0447), 'button_style'));
  arrButton.push(createButton('C', String.fromCharCode(0x0441), 'button_style'));
  arrButton.push(createButton('V', String.fromCharCode(0x043C), 'button_style'));
  arrButton.push(createButton('B', String.fromCharCode(0x0438), 'button_style'));
  arrButton.push(createButton('N', String.fromCharCode(0x0442), 'button_style'));
  arrButton.push(createButton('M', String.fromCharCode(0x044C), 'button_style'));
  arrButton.push(createButton('.', '.', 'button_style'));
  arrButton.push(createButton(',', ',', 'button_style'));
  arrButton.push(createButton('/', '/', 'button_style'));
  arrButton.push(createButton(String.fromCharCode(0x2191), String.fromCharCode(0x2191), 'button_style'));
  arrButton.push(createButton('Shift', 'Shift', 'button_style_func'));
  ...
  arrButton.push(createButton('Alt', 'Alt', 'button_style'));
  arrButton.push(createButton('Ctrl', 'Ctrl', 'button_style'));
  arrButton.push(createButton(String.fromCharCode(0x2190), String.fromCharCode(0x2190), 'button_style')); // влево
  arrButton.push(createButton(String.fromCharCode(0x2193), String.fromCharCode(0x2193), 'button_style')); //вниз
  arrButton.push(createButton(String.fromCharCode(0x2192), String.fromCharCode(0x2192), 'button_style')); //вправо
}
...
createLine(startLine1, startLine2, arrButton);
createLine(startLine2, startLine3, arrButton);
createLine(startLine3, startLine4, arrButton);
createLine(startLine4, startLine5, arrButton);
createLine(startLine5, startLine6, arrButton);
